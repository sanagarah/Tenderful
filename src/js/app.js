...
//TODO Helloworld
    ...
    registerNanny: function (event){
        event.preventDefault();
        window.location.href = "../nannyRegisteration.html";
    ...
    registerButtonNanny: function(event){
        ...
        web3.eth.getAccounts(function (error, accounts) {
            ...
            App.contracts.babySitters.deployed().then(function (instance) {
                babySittersInstance = instance;

                // Execute adopt as a transaction by sending account
                return babySittersInstance.registerAsNanny( , , , {from: account});
            }).then(function (result) {
                return App.markAdopted();
            }).catch(function (err) {
                console.log(err.message);
